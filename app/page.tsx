          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-4">
            <div className="bg-white rounded-2xl border border-slate-200 px-5 py-4" style={{ boxShadow: "0 1px 8px rgba(15,32,68,0.06)" }}>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                ...
                <select value={searchLevel} onChange={e => setSearchLevel(e.target.value)} className={sl}>{LEVEL_OPTIONS.map(l => <option key={l} value={l}>{l === "All Levels" ? t.allLevels : l === "State" ? t.stateLvl : l === "Central" ? t.central : t.trust}</option>)}</select>
